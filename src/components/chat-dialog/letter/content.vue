<template>
  <div class="letter-content animate__animated animate__fadeInUp">
    <div class="letter-title" ref="letter-title"></div>
    ...
    <var-back-top style="z-index: 2000" :duration="300"> </var-back-top>
  </div>
</template>
          ...
          return new Promise((resolve) => {
            ...
            if (isImg) {
              ...
              this.$nextTick(() => {
                ...
                this.append(textContent.dom, paragraph).then(() => {
                  this.autoScroll();
                  resolve();
                });
              });
